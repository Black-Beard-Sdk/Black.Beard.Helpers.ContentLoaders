...
namespace Bb.Configurations
{
    ...
    public class ContentFolder
    {
        ...
        /// folder.AddCallingAssemblyDirectory();
        /// </code>
        /// </example>
        public void AddCallingAssemblyDirectory(bool insertFirst = false)
        {
            AddAssemblyDirectory(Assembly.GetCallingAssembly(), insertFirst);
        }
        ...
        /// <example>
        /// <code lang="C#">
        /// var folder = new ContentFolder("Configuration");
        /// folder.AddDirectoryIfExists("C:\\MyConfigs");
        /// </code>
        /// </example>
        public void AddDirectoryIfExists(string folder, bool insertFirst = false)
        {
            AddDirectoryIfExists(new DirectoryInfo(folder), insertFirst);
        }
