...
namespace RandomDataGenerator.Generators
{
    ...
    internal class RandomValueGenerator
    {
        ...
        public static Type[] SupportedTypes { get; } = { typeof(decimal), typeof(bool), typeof(byte), typeof(short), typeof(int), typeof(long), typeof(float), typeof(double), typeof(long), typeof(DateTime), typeof(TimeSpan) };
